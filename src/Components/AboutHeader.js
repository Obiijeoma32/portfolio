...
function AboutHeader() {
  ...
  const [hamburger, setHamburger] = useState(false); //   const [scrollView, setScrollView] = useState(0);
  ...
  return (
    <>
      ...
      <div className={` 3xxS:flex w-full left-0 top-0 justify-center h-[70px] z-1   pr-[10px] fixed items-center 1xS:hidden ${navBar ? "bg-opacity-20  bg-black" : " bg-transparent"} `}>
      ...
      {hamburger && (
        <div className="bg-[#000000] top-0 z-2 font-medium bg-opacity-80 w-[100%] h-screen fixed text-[#fff] text-[32px] ">
          <div className=" float-right w-fit h-fit mt-[20px] mr-[20px]  ">
      ...
      <div className=" 3xxS:hidden 1xS:flex  fixed w-full top-0 ">
        <div className={navBar ? "w-[100%] h-[100px]  pl-[50px] pr-[55px] flex  justify-between items-center bg-opacity-20  bg-black" : "w-[100%] h-[100px] fixed pl-[50px] pr-[55px] flex  justify-between items-center bg-transparent"}>
          <Logo />
