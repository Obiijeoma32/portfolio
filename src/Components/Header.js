...
function Header({ children }) {
  ...
  return (
    <>
      <div className="3xxl:w-[90%]  3xxl:pl-[0px] header-container lg:w-[100%] md:w-[90%]  text-[#000000]  flex  ">
        <div className=" 3xxl:w-[px] ">
        ...
        <Link to="/home" className="mt-[-10px] md:ml-[15px]">
        ...
        <div className="lg:flex hidden mt-[5px] ml-[37rem] w-[300px]  justify-between 2xl:ml-[65%]">
        ...
        <div className="lg:hidden  flex justify-end h-[80px] pb-[40px] w-[250px]">
          <div className=" w-[100px]">
            ...
            {hamBurgerMenu && (
              <div className=" w-[150px] pt-[10px] z-[99] h-[130px] rounded-[5px] shadow-lg bg-[#f3f3f3]  ">
