      ...
      <div className="mt-[11rem] flex justify-between ml-[5rem] mr-[3rem] w-[85%]">
        ...
        <div>
          <form autoComplete="on" className="" action="https://formsubmit.co/obiijeoma32@gmail.com" method="POST">
            <div className="flex contact-form mt-4 w-[550px] justify-between items-center">
              <span>
                <label className="font-[400] text-[#000]  text-[16px]" htmlFor="Fname">
                  First Name
                </label>
                <br />
                <input className="w-[250px]  bg-transparent  pl-2 h-[40px]" type="text" name="Fname" />
              </span>
              <span>
                ...
                <br />
                <input className="w-[250px] pl-2  bg-transparent  h-[40px]" type="text" name="Lname" />
              </span>
            </div>
            <div className=" contact-form mt-4 flex w-[550px] justify-between items-center">
              <span>
                <label className="font-[400] text-[#000]  text-[16px]" htmlFor="email">
                  Email
                </label>
                <br />
                <input className="w-[250px]  pl-2 bg-transparent  h-[40px]" type="email" name="email" />
              </span>
              <span>
                ...
                <br />
                <input className="w-[250px]  pl-2 bg-transparent  h-[40px]" type="text" name="subject" />
              </span>
            </div>
            <div className=" contact-form mt-4 flex w-[500px] justify-between items-center">
              <span>
                <label className="font-[400] text-[#000]  text-[16px]" htmlFor="Message">
                  Enter Message
                </label>
                <br />
                <textarea className="w-[300px]  p-2 bg-transparent " cols="" rows="5" />
              </span>
              <button type="submit" className="socials2  font-[500] text-[20px] rounded-[100%] pt-[60px] w-[150px] h-[150px]  outline  outline-1 bg-[#fdc244] hover:bg-[#fff] ">
                <h3 className="text-center pb-12">Submit</h3>
              </button>
            </div>
          </form>
        </div>
